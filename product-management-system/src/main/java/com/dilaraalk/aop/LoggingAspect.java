...
public class LoggingAspect {
	...
	//metot çalışmadan önce logladım
	@Before(value = "serviceMethods()")
	public void logBefore(JoinPoint joinPoint) {
		Object[] args = joinPoint.getArgs();
		String  methodName = joinPoint.getSignature().getName(); // methodunu adını almak için 
		logger.debug(">> {}() - {}", methodName, Arrays.toString(args));
	}
	
	//metot düzgün çalışıp sonucu döndürünce logladım
